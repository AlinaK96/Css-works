...
$work_experience = [
    [
        'profession' => 'Кот в отставке',
        'date_start' => 'Ноябрь 2022',
        'date_end' => 'Current',
        'information' => 'Спокойная и размеренная жизнь',
    ],
    [
        'profession' => 'Главный по охране дома',
        'date_start' => 'Март 2022',
        'date_end' => 'Ноябрь 2022',
        'information' => 'Начальник отдела охоты и охраны',
    ],
    [
        'profession' => 'Помощник домашнего кота по охоте на крыс',
        'date_start' => 'Март 2021',
        'date_end' => 'Март 2022',
        'information' => 'Обнаружение крыс и мышей на территории дома',
    ],
];
?>
      ...
      <div class="w3-twothird">
        <div class="w3-container w3-card w3-white w3-margin-bottom">
          <h2 class="w3-text-grey w3-padding-16"><i
            ...
            <div class="w3-container">
                <h5 class="w3-opacity"><b><?= $work_experience[$i]["profession"]; ?></b></h5>
                <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i>
                
                <?php if($i == 0):?>
                <?= $work_experience[$i]['date_start']; ?> - <span
                class="w3-tag w3-teal w3-round"><?= $work_experience[$i]['date_end']; ?></span></h6>
                <?php else:?>
                <?= $work_experience[$i]['date_start']; ?> - <?= $work_experience[$i]['date_end']; ?></h6>
                <?php endif;?>
                <?php ?>
            <p><?= $work_experience[$i]['information']; ?></p>
            <hr>
          </div>
            <?php endfor;?>
